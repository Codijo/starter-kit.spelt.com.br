...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Credenciais do gate do dashboard (HorizonBasicAuthMiddleware). Sem elas, o
    | dashboard fica trancado (401). Defina em produção via HORIZON_BASIC_AUTH_*.
    |
    */
    ...
    */
    ...
    'defaults' => [
        'supervisor-1' => [
            ...
            'memory' => 128,
            'tries' => 1,
            // >= maior $timeout de job (GenerateHooksJob usa 120) e < retry_after do Redis.
            'timeout' => 150,
            'nice' => 0,
        ],
    ],
